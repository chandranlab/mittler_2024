...
A raw CRISPR/Cas9 screen dataset from [Kulsuptrakul et al.](https://dx.doi.org/10.1101/2019.12.15.877100) was used for testing the bash --> mageck analysis pipeline and is available for download on [EBI ArrayExpress](https://www.ebi.ac.uk/biostudies/arrayexpress/studies/E-MTAB-8646). 
