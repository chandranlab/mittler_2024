#!/bin/bash
# Usage: pooled_CRISPR_screen_Gecko_v2_reorient.sh fastqlist
# fastqlist is a .txt file containing the list of fastq file base names to be processed (one per row). 
